  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto w-full">
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900 mb-1">Audit Logs</h1>
        <p className="text-sm text-gray-500">On-chain transaction history for the Credibly program.</p>
      </motion.div>

      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="bg-gray-50 border-b border-gray-100 px-5 py-2.5 grid grid-cols-12 gap-3 text-[11px] tracking-wider uppercase font-semibold text-gray-400">
          ...
          <div className="divide-y divide-gray-50 max-h-[500px] overflow-y-auto">
            {logs.map((log, i) => (
              <motion.div
                ...
                key={log.signature}
                className="px-5 py-3 grid grid-cols-12 gap-3 items-center hover:bg-gray-50/50 transition-colors group"
              >
                <div className="col-span-5 font-mono text-gray-600 text-xs truncate">{log.signature}</div>
                <div className="col-span-4 text-gray-500 text-xs flex items-center gap-1">
                ...
                <div className="col-span-1 flex justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                  <a href={`https://explorer.solana.com/tx/${log.signature}?cluster=devnet`} target="_blank" rel="noreferrer" className="p-1 text-gray-400 hover:text-gray-700 rounded hover:bg-gray-100 transition-colors">
